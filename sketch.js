...
var sad_sound;
var eating_sound;
var empty_star,two_star,starimg,one_star,star,star2;
var blow_air;
var star_score;
function preload()
{
...
function setup() 
{
  ...
  blow_air = createImg("baloon2.png");
  blow_air.position(260,370);
  blow_air.size(120,120);
  blow_air.mouseClicked(air_blow);
  ...
  star_score = createSprite(70,40,30,30);
